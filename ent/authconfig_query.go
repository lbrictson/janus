...
func (acq *AuthConfigQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (acq *AuthConfigQuery) FirstIDX(ctx context.Context) int {
...
func (acq *AuthConfigQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (acq *AuthConfigQuery) OnlyIDX(ctx context.Context) int {
...
func (acq *AuthConfigQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (acq *AuthConfigQuery) IDsX(ctx context.Context) []int {
	ids, err := acq.IDs(ctx)
	if err != nil {
		panic(err)
	}
