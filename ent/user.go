...
func (e UserEdges) ProjectUsersOrErr() ([]*ProjectUser, error) {
	if e.loadedTypes[0] {
...
// QueryProjectUsers queries the "projectUsers" edge of the User entity.
func (u *User) QueryProjectUsers() *ProjectUserQuery {
	return NewUserClient(u.config).QueryProjectUsers(u)
}
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.EncryptedPassword))
	builder.WriteString(", ")
