...
func EncryptedPassword(v []byte) predicate.User {
...
func EncryptedPasswordEQ(v []byte) predicate.User {
	return predicate.User(sql.FieldEQ(FieldEncryptedPassword, v))
}

// EncryptedPasswordNEQ applies the NEQ predicate on the "encrypted_password" field.
func EncryptedPasswordNEQ(v []byte) predicate.User {
...
func EncryptedPasswordIn(vs ...[]byte) predicate.User {
...
func EncryptedPasswordNotIn(vs ...[]byte) predicate.User {
...
func EncryptedPasswordGT(v []byte) predicate.User {
...
func EncryptedPasswordGTE(v []byte) predicate.User {
...
func EncryptedPasswordLT(v []byte) predicate.User {
...
func EncryptedPasswordLTE(v []byte) predicate.User {
...
// HasProjectUsersWith applies the HasEdge predicate on the "projectUsers" edge with a given conditions (other predicates).
func HasProjectUsersWith(preds ...predicate.ProjectUser) predicate.User {
	return predicate.User(func(s *sql.Selector) {
