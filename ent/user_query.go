...
func (_q *UserQuery) QueryProjectUsers() *ProjectUserQuery {
...
func (_q *UserQuery) WithProjectUsers(opts ...func(*ProjectUserQuery)) *UserQuery {
	query := (&ProjectUserClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadProjectUsers(ctx context.Context, query *ProjectUserQuery, nodes []*User, init func(*User), assign func(*User, *ProjectUser)) error {
