...
func HasProjectUsersWith(preds ...predicate.ProjectUser) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
...
func HasHistory() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasHistoryWith(preds ...predicate.JobHistory) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := newHistoryStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
